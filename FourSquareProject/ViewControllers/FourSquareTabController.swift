...
class FourSquareTabController: UITabBarController {
    ...
    private var datapersistance = DataPersistence<Venue>(filename: "savedVenues.plist")

    private lazy var mapVC: MapViewController = {
       let vc = MapViewController(datapersistance)
    ...
    private lazy var savedVC: SavedViewController = {
       let vc = SavedViewController(datapersistance)
